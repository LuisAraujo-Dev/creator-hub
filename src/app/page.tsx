...
import { ArrowRight, Check, Zap, Star, Shield } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden md:flex gap-6 text-sm font-medium text-slate-600">
            ...
            <Link href="#" className="hover:text-blue-600 transition">Exemplos</Link>
          </nav>
        ...
        <section className="py-20 md:py-32 text-center px-4 bg-linear-to-b from-blue-50/50 to-white">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/correluisaraujo">
                <Button variant="outline" size="lg" className="h-12 px-8 text-base w-full sm:w-auto">
                  Ver exemplo ao vivo
                </Button>
              </Link>
            </div>
            <p className="mt-4 text-xs text-slate-500">Não requer cartão de crédito • Plano grátis disponível</p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <FeatureCard 
                ...
                description="Liste seus produtos da Amazon, Shopee ou Hotmart com imagem e preço. Ganhe comissões mais rápido."
              />
              <FeatureCard 
                icon={<Star className="h-6 w-6 text-purple-500" />}
                title="Cupons de Desconto"
                description="Parcerias com marcas? Disponibilize códigos de desconto fáceis de copiar para sua audiência."
              />
              <FeatureCard 
                icon={<Shield className="h-6 w-6 text-blue-500" />}
                title="Analytics Simples"
                description="Saiba exatamente quantos cliques cada produto recebeu e otimize sua estratégia."
              />
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm hover:shadow-md transition-all">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <ListItem check>Até 2 Links Sociais</ListItem>
                  <ListItem check>Até 3 Produtos</ListItem>
                  <ListItem check>Até 3 Cupons</ListItem>
                  <ListItem check={false}>Analytics Avançado</ListItem>
              ...
              <div className="relative rounded-2xl border-2 border-blue-600 bg-white p-8 shadow-xl scale-105">
                ...
                <ul className="space-y-3 text-sm">
                  ...
                  <ListItem check>Sem marca d'água</ListItem>
